...
namespace WindowsFormsApp1
{
    public partial class frmthongtin : Form
    {
        ...
        private void btn_sua_Click_2(object sender, EventArgs e)
        {
            try
            {
                sua();
        ...
        private void btn_doimk_Click_2(object sender, EventArgs e)
        {
            frmdoimk frm = new frmdoimk();
            frm.ShowDialog();
        }

        private void txt_idql_TextChanged(object sender, EventArgs e)
        {
